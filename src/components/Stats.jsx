            ...
            <div className='max-w-container mx-auto px-4'>
                <div className='flex'>
                    ...
                    <div className='mb-8 w-1/4 text-center'>
                        <div className='mb-6 inline-block p-4 rounded bg-green-100'>
                        ...
                        <p className='text-2xl font-bold'>{x.followers}</p>
                    ...
                    <div className='mb-8 w-1/4 text-center'>
                        ...
                        <p className='text-2xl font-bold'>{x.solved}</p>
                    ...
                    <div className='mb-8 w-1/4 text-center'>
                        ...
                        <p className='text-2xl font-bold'>{x.customers}</p>
                    ...
                    <div className='mb-8 w-1/4 text-center'>
                        ...
                        <p className='text-2xl font-bold'>{x.projects}</p>
