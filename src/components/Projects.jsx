        ...
        <section className='bg-gray-50 py-20'>
            <div className='max-w-container mx-auto px-4'>
                ...
                <div className='mb-16 flex justify-between items-center'>
                    ...
                    <Link className='py-3 px-6 rounded-l-xl rounded-t-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold  duration-200' href='/projects'>View More Projects</Link>
                </div>
